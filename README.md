...
| MapBiomas Degradação   | EstatisticasDegradacao   | [diag_estatisticas_mapbiomas_degradacao](./diag_estatisticas_mapbiomas_degradacao.md) | [etl_estatisticas_mapbiomas_degradacao.py](./etl_estatisticas_mapbiomas_degradacao.py) | 🚧 em desenvolvimento |
